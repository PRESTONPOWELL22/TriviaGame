...
$(document).ready(function(){
    ...
    var questions = [
        ...
        "3. A javascript library that helps with dynamic page manipulation",
    ...
    $("#game").click(function(){
        ...
        $(".q1a1").append(answers[0])
        $(".q1a2").append(answers[1])
        $(".q1a3").append(answers[4])
